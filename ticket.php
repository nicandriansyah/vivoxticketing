...
<body class="ticket-page">
    ...
    <div class="ticket-card" id="card-<?= $i ?>">
        ...
        <div class="tc-top">
            <img src="logo.png" alt="Vita Voxa Choir" class="tc-logo" draggable="false" oncontextmenu="return false">
        ...
        <h2 class="tc-title"><img src="foas-logo-black.png" alt="FOAS 14" class="tc-title-img" draggable="false" oncontextmenu="return false"></h2>
        <p class="tc-subtitle">I KNOW MY REDEEMER LIVES</p>
