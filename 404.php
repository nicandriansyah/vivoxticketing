...
// Bisa di-include dari dalam fungsi (mis. show404 di ticket.php) — ambil dari $GLOBALS.
$msg = $notfound_msg ?? $GLOBALS['notfound_msg'] ?? 'Periksa kembali link tiket yang sudah diberikan.';
require_once __DIR__ . '/config/db.php';
require_once __DIR__ . '/config/checkin.php';
$helpC = helpContact($pdo ?? $GLOBALS['pdo'] ?? null);
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Tiket Tidak Tersedia — FOAS 14</title>
...
<body>
    <div class="nf-box">
        ...
        <div class="nf-contact">
            ...
            <br>
            <a class="nf-wa" href="https://wa.me/<?= htmlspecialchars($helpC['wa']) ?>?text=<?= $waText ?>" target="_blank" rel="noopener">
        ...
        <p class="nf-brand">Vita Voxa Choir &middot; FOAS 14</p>
    </div>
</body>
</html>
